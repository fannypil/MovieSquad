...
router.delete('/me/watched/:tmdbId/:tmdbType', auth, userController.removeWatchedContent);
...
router.delete('/me/favorite-movies/:tmdbId', auth, userController.removeFavoriteMovie);
...
router.delete('/me/genres/:genreName', auth, userController.removeFavoriteGenre);
